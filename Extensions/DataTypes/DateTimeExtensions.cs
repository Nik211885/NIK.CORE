...
public static class DateTimeExtensions
{
    ...
    extension(DateTime dateTime)
    {
        ...
        /// </summary>
        public bool IsMin() => dateTime == DateTime.MinValue;

        /// <summary>
        /// Determines whether the DateTime equals <see cref="DateTime.MaxValue"/>.
        /// </summary>
        public bool IsMax() => dateTime == DateTime.MaxValue;
        /// <summary>
        ...
        /// </summary>
        public DateTime EndOfDay() => dateTime.Date.AddDays(1).AddTicks(-1);
        /// <summary>
        /// Determines whether the DateTime is within the specified range (inclusive).
        /// </summary>
        public bool IsBetween(DateTime from, DateTime to) => dateTime >= from && dateTime <= to;
        /// <summary>
    ...
    extension(DateTimeOffset dateTime)
    {
        ...
        /// </summary>
        public bool IsMin() => dateTime == DateTimeOffset.MinValue;
        /// <summary>
        /// Determines whether the value equals <see cref="DateTimeOffset.MaxValue"/>.
        /// </summary>
        public bool IsMax() => dateTime == DateTimeOffset.MaxValue;
        /// <summary>
        ...
        /// </summary>
        public bool IsBetween(DateTimeOffset from, DateTimeOffset to)
        ...
        /// </returns>
        public DateTimeOffset ToTimeZone(string timeZoneId)
        {
